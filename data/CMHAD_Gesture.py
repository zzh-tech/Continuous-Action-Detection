...
class GestureDataset(Dataset):
    """
    Dataset Class for C-MHAD TV Gestures
    """

    def __init__(self, set='train'):
        self.dataset_path = '/home/zhong/Dataset/C-MHAD'
        self.dataset_group = 'TVGestureApplication'
        self.subject_index = list(range(1, 13))
        self.label_info = {}
        self.num_channel = 6
        self.freq = 50
        self.seq_length = 8 * self.freq  # 8 seconds
    ...
    def get_label_path(self, subject):
        label_path = join(self.dataset_path,
                          ...
                          'ActionOfInterestTVSubject{}.xlsx'.format(subject)
                          )
        return label_path
    ...
    def load_data_frame(self, subject, trial):
        ...
        data_path = join(dirname(label_path),
                         'InertialData',
                         'inertial_sub{}_tv{}.csv'.format(subject, trial)
                         )
...
class Dataloader(object):
    def __init__(self, para, ds_type='train'):
        ...
        bs = para.batch_size
        self.dataset = module.GestureDataset(set=ds_type)
